...
// var learningEntries = []models.LearningEntry{
// 	{ID: 0, Title: "Learning Binary Search", Description: "O(logn) time", Date: time.Now(), Completed: false},
// 	{ID: 1, Title: "Learning Linked List", Description: "O(n) time", Date: time.Now(), Completed: false},
// }

// var learningGoals = []models.LearningGoals{
...
// 		entries, err := database.GetAllEntriesByGoalID(goalID)
// 		if err != nil {
